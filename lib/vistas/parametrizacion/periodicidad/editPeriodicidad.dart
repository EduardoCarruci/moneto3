  ...
  edit() async {
    if (_formKey.currentState.validate()) {
      ...
      await servicio.edit(widget.data_user.Token, data,
          widget.periodicidad.idPeriodicidad.toString(), context,'api/Periodicidad/Update/');
  ...
  delete() async {
   if (_formKey.currentState.validate()) {
      ...
      await servicio.delete(widget.data_user.Token, data,
          widget.periodicidad.idPeriodicidad.toString(), context,'api/Periodicidad/Delete/');
