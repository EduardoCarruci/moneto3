...
class EditFranquicia extends StatefulWidget {
  ...
  EditFranquicia(this.data_user, this.franquicia);
  @override
  _EditState createState() => new _EditState();
}

class _EditState extends State<EditFranquicia> {
  ...
  void initState() {
    ...
    _DescripcionController =
        new TextEditingController(text: widget.franquicia.descripcion);
    _CodigoController =
        new TextEditingController(text: widget.franquicia.codigo);
  }
