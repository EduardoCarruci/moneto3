...
class _EditState extends State<EditEstrato> {
  ...
  void initState() {
    super.initState();
    _NombreController = new TextEditingController(text: widget.estrato.nombre);
    _CodigoController = new TextEditingController(text: widget.estrato.codigo);
  }
  ...
  edit() async {
    if (_formKey.currentState.validate()) {
      ...
      Map data = item.convertMapOP(widget.estrato.idEstrato.toString(),
  ...
  delete() async {
    ...
    Navigator.push(context,
        MaterialPageRoute(builder: (context) => ListEstrato(widget.data_user)));
  }
}
