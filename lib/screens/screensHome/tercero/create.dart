                              ...
                              child: Container(
                                child: DropdownButton<String>(
                                  ...
                                  onChanged: (String value) async {
                                    ...
                                    if (nuevoTercero == null && numeroController.text=="") {
                                      print("no hubo registros");
                                      bandera = false;
                                    } else if(nuevoTercero != null && numeroController.text!=""){
                                      ...
                                      nombrecontroller.text= nuevoTercero.nombre.toString().trim();  
                                      apellidosController.text= nuevoTercero.apellido.toString().trim();
                                      emailcontroller.text = nuevoTercero.mail.toString();
                                      telefonocontroller.text = nuevoTercero.telefono.toString();
                                      direccionController.text = nuevoTercero.direccion.toString();                                     
                                      _fechaController.text = nuevoTercero.fechaNacimiento.toString();
                                       hijosController.text = nuevoTercero.hijos.toString();

                                     
                                      idTipoIdentificacion = nuevoTercero.idTipoIdentificacion.toString();
                                      idGenero = nuevoTercero.idGenero.toString();
                                      idEstrato = nuevoTercero.idEstrato.toString();            
                                      idEstadoCivil = nuevoTercero.idEstadoCivil.toString();
